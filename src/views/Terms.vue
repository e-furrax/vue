<template>
  <div class="my-20 container mx-auto text-white">
    <h1 class="text-3xl text-center font-bold">E-FURRAX Terms of Service</h1>
    <p class="text-center mb-10">Last updated: 30th of June, 2021</p>

    <h2 class="text-2xl text-indigo-400 mb-3">Terms</h2>
    <p>
      The E-furrax website located at https://e-furrax.com/ is a copyrighted work belonging to
      E-furrax. Certain features of the Site may be subject to additional guidelines, terms, or
    ...
    <p>
      ...
      (c) you shall not access the Site in order to build a similar or competitive website; and (d)
      ...
      Site shall be subject to these Terms.All copyright and other proprietary notices on the Site
    ...
    <p>
      <strong>User Content.</strong> "User Content" means any and all information and content that a
      ...
      responsible for your User Content, you may expose yourself to liability. Company is not
      obliged to backup any User Content that you post; also, your User Content may be deleted at
      any time without prior notice to you. You are solely responsible for making your own backup
    ...
    <p>
      ...
      physical harm of any kind against any group or individual; (iii) that is harmful to minors in
      any way; or (iv) that is in violation of any law, regulation, or obligations or restrictions
    ...
    <p>
      ...
      letters, pyramid schemes, or any other form of duplicative or unsolicited messages; (iii) use
      the Site to harvest, collect, gather or assemble information or data regarding other users
      ...
      or any other means; (vi) harass or interfere with any other user’s use and enjoyment of the
      Site; or (vi) use software or automated agents or scripts to produce multiple accounts on the
    ...
    <p>
      ...
      fully exploit such Feedback and related information in any manner it believes
    ...
    <p>
      ...
      and services, and/or display advertisements for third-parties.Such Third-Party Links & Ads are
      not under the control of Company, and Company is not responsible for any Third-Party Links &
      Ads. Company provides access to these Third-Party Links & Ads only as a convenience to you,
    ...
    <p>
      <strong>Other Users.</strong> Each Site user is solely responsible for any and all of its own
    ...
    <p>
      <strong>Cookies and Web Beacons.</strong> Like any other website, E-furrax uses ‘cookies’.
      These cookies are used to store information including visitors’ preferences, and the pages on
      the website that the visitor accessed or visited. The information is used to optimize the
      users’ experience by customizing our web page content based on visitors’ browser type and/or
      other information.
    </p>

    <p>
      <strong>Our Advertising Partners.</strong> Some of advertisers on our site may use cookies and
    ...
    <p>
      ...
      than one claim will not enlarge this limit.You agree that our suppliers will have no liability
    ...
    <p>
      ...
      in violation of these Terms.Upon termination of your rights under these Terms, your Account
    ...
    <p>
      ...
      e-mail notice to you or thirty (30) calendar days following our posting of notice of the
      changes on our Site.These changes will be effective immediately for new users of our
      Site.Continued use of our Site following notice of such changes shall indicate your
    ...
    <p>
      ...
      the Company should be sent to: 242 Rue du Faubourg Saint-Antoine, 75012 Paris. After the
    ...
    <p>
      ...
      neutral arbitrator.Any claims or disputes where the total amount of the award sought is less
      ...
      the U.S., the arbitrator shall give the parties reasonable notice of the date, time and place
      of any oral hearings. Any judgment on the award rendered by the arbitrator may be entered in
      any court of competent jurisdiction.If the arbitrator grants you an award that is greater than
      the last settlement offer that the Company made to you prior to the initiation of arbitration,
      the Company will pay you the greater of the award or $2,500.00.Each party shall bear its own
    ...
    <p>
      ...
      shall have the authority to grant motions dispositive of all or part of any claim.The
      arbitrator shall have the authority to award monetary damages, and to grant any non-monetary
      remedy or relief available to an individual under applicable law, the AAA Rules, and the
      Terms. The arbitrator shall issue a written award and statement of decision describing the
    ...
    <p>
      ...
      expensive than rules applicable in a court and are subject to very limited review by a
    ...
    <p>
      <strong>Small Claims Court.</strong> Nonetheless the foregoing, either you or the Company may
    ...
    <p>
      ...
      misappropriation of the other party’s patent, copyright, trademark or trade secrets shall not
    ...
    <p>
      ...
      to the maximum extent permitted by law.Your relationship to Company is that of an independent
    ...
    <p>Address: 242 Rue du Faubourg Saint-Antoine, 75012 Paris</p>
    <p>Email: basile.beauprez.simu@gmail.com</p>
  </div>
</template>
