<template>
  ...
  <p>
    ...
    E-furrax. Certain features of the Site may be subject to additional guidelines, terms, or rules,
  ...
  <p>
    ...
    its content are owned by Company or Company’s suppliers. Note that these Terms and access to the
  ...
  <p>
    <strong>Cookies and Web Beacons.</strong> Like any other website, E-furrax uses ‘cookies’. These
  ...
  <p>
    ...
    one claim will not enlarge this limit.You agree that our suppliers will have no liability of any
  ...
  <p>
    ...
    rights under these Terms.Even after your rights under these Terms are terminated, the following
    provisions of these Terms will remain in effect: Sections 2 through 2.5, Section 3 and Sections
    4 through 10.
  </p>
  ...
  <p>
    ...
    the Company should be sent to: 242 Rue du Faubourg Saint-Antoine, 75012 Paris. After the Notice
    is received, you and the Company may attempt to resolve the claim or dispute informally.If you
    and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is
  ...
  <p>
    ...
    arbitration as set forth in this section.If AAA is not available to arbitrate, the parties shall
    agree to select an alternative ADR Provider.The rules of the ADR Provider shall govern all
    aspects of the arbitration except to the extent such rules are in conflict with the Terms. The
    AAA Consumer Arbitration Rules governing the arbitration are available online at adr.org or by
  ...
  <p>
    ...
    findings and conclusions on which the award is based.The arbitrator has the same authority to
